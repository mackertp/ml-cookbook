...
If you're experienced with TypeScript and application frameworks, I recommend starting with [Storybook](https://storybook.js.org/docs/get-started/react-vite). I've deployed one at [design.sip-research.com](https://design.sip-research.com/).
